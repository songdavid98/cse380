...
export class PauseScene extends Phaser.Scene{
    ...
    create(){
        ...
        let controlsButton = this.add.image(this.game.renderer.width*.5,this.game.renderer.height*.7,"blueBar").setDepth(2).setScale(2,2);
        let exitButton = this.add.image(this.game.renderer.width*.5,this.game.renderer.height*.9,"blueBar").setDepth(2).setScale(2,2);
